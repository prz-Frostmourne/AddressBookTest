...
- (IBAction)addPersonClick:(UIButton *)sender {
    ...
    ABRecordSetValue(recordRef, kABPersonFirstNameProperty, @"员辉", NULL);
    ABRecordSetValue(recordRef, kABPersonLastNameProperty, @"陈", NULL);
    ABMultiValueRef multiValueRef = ABMultiValueCreateMutable(kABStringPropertyType);
    ABMultiValueAddValueAndLabel(multiValueRef, @"13428283530", kABHomeLabel, NULL);
